...
namespace Marksman
{
    internal class Program
    {
        ...
        {
            Config = new Menu("ADC英雄合集", "Marksman", true);
            CClass = new Champion();
            ...
            QuickSilverMenu = new Menu("水银饰带", "QuickSilverSash");
            items.AddSubMenu(QuickSilverMenu);
            QuickSilverMenu.AddItem(new MenuItem("AnyStun", "解除 眩晕").SetValue(true));
            QuickSilverMenu.AddItem(new MenuItem("AnySlow", "解除 减速").SetValue(true));
            QuickSilverMenu.AddItem(new MenuItem("AnySnare", "解除 陷阱").SetValue(true));
            QuickSilverMenu.AddItem(new MenuItem("AnyTaunt", "解除 嘲讽").SetValue(true));
            ...
            items.AddItem(
                new MenuItem("UseItemsMode", "使用物品").SetValue(
                    new StringList(new[] {"禁用", "混合", "连招", "全部"}, 2)));
            ...
            if (BaseType != CClass.GetType())
            {
                ...
                {
                    harass.AddItem(new MenuItem("HarassMana", "骚扰最低蓝量").SetValue(new Slider(50, 100, 0)));
                ...
                {
                    laneclear.AddItem(
                        new MenuItem("LaneClearMana", "清线最低蓝量").SetValue(new Slider(50, 100, 0)));
                ...
                {
                    drawing.AddItem(
                        new MenuItem("drawMinionLastHit", "标记补刀小兵").SetValue(new Circle(false,
                            System.Drawing.Color.GreenYellow)));
                    drawing.AddItem(
                        new MenuItem("drawMinionNearKill", "标记附近可击杀小兵").SetValue(new Circle(false,
