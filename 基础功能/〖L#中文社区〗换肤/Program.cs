...
namespace Skin_Changer
{
    class Program
    {
        ...
        public static void Game_OnGameLoad(EventArgs args)
        {
            Game.PrintChat(
            string.Format(
                "{0} v{1} Skin Changer - Parable of the cheap man by MetaPhorce 鍔犺浇鎴愬姛",
            ...
            Config = new Menu("〖L#中文社区〗皮肤更换", "SkinChanger", true);
            var ChangeSkin = Config.AddItem(new MenuItem("CycleSkins", "更换皮肤（数字9）!").SetValue(new KeyBind("9".ToCharArray()[0], KeyBindType.Toggle)));
            Config.AddItem(new MenuItem("cChange", "开启换肤").SetValue(new KeyBind("I".ToCharArray()[0], KeyBindType.Toggle)));
        ...
        private static void Game_OnWndProc(WndEventArgs args)
        {
            ...
            foreach (var hero in ObjectManager.Get<Obj_AI_Hero>())
            {
                ...
                {
                    Game.PrintChat(hero.ChampionName + " 鍔犺浇鎴愬姛");
                    skinTarget = hero;
