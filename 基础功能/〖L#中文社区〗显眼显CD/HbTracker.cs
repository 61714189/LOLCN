...
namespace Tracker
{
    ...
    public static class HbTracker
    {
        ...
        {
            Config = menu.AddSubMenu(new Menu("CD 显示", "CD Tracker"));
            Config.AddItem(new MenuItem("TrackAllies", "显示敌方").SetValue(true));
            Config.AddItem(new MenuItem("TrackEnemies", "显示队友").SetValue(true));
