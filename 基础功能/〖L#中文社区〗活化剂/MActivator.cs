...
namespace MasterActivator
{
    internal class MActivator
    {
        ...
        {
            // Boas vindas
	            Game.PrintChat("<font color=\"#FFFFFF\"> YY棰戦亾:58835562 杈呭姪寮€榛戙€佷氦鍙嬨€佸ū涔愶紝姣忔棩17:00-22:00鎺ュ緟缁勭粐寮€榛憒</font> <font color=\"#FFFF00\">        L#涓枃绀惧尯 www.loll35.com</font> ");
            try
            {
        ...
        private void createMenu()
        {
            ...
            Config.AddSubMenu(new Menu("Auto Shield", "自动庇护"));
