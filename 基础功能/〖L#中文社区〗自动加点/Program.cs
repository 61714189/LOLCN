...
namespace UniversalLeveler
{
    internal static class Program
    {
        ...
        private static void OnGameLoad(EventArgs args)
        {
            ...
            _menu = new Menu("〖L#中文社区〗自动加点", "UniversalLeveler" + ObjectManager.Player.ChampionName, true);
        ...
        {
            Game.PrintChat(
                "<font color='#ff3232'>Universal</font><font color='#BABABA'>鑷姩鍔犵偣:鍔犺浇鎴愬姛</font> <font color='#FFFFFF'>" +
                msg + "</font>");
        }
