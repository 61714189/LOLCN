    ...
    public class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>Dev|鍗″皵鐜泑 鍔犺級鎴愬姛 v{0}</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        {
            Config = new Menu("〖L#中文社区〗Dev卡尔玛", "DevKarma", true);
