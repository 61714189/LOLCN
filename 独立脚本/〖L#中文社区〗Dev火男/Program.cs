    ...
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>Dev鐏敺|v{0} 鍔犺級鎴愬姛</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        {
             Config = new Menu("〖L#中文社区〗Dev 火男", "DevBrand", true);
