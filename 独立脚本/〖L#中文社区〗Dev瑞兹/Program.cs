    ...
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            try
            {
                ...
                Game.PrintChat(string.Format("<font color='#fb762d'>Dev鐟炲吂v{0} 鍔犺浇鎴愬姛</font>", Assembly.GetExecutingAssembly().GetName().Version));
        ...
        private static void InitializeMainMenu()
        {
            ...
            Config = new Menu("〖L#中文社区〗Dev 瑞兹", "DevRyze", true);
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseAACombo", "使用 技能后 连招").SetValue(true));
            Config.SubMenu("Combo").AddItem(new MenuItem("UseRComboToggle", "使用 R (连招效果)").SetValue(new KeyBind("G".ToCharArray()[0], KeyBindType.Toggle)));
            ...
            Config.AddSubMenu(new Menu("追击 敌人", "Chase"));
            ...
            Config.SubMenu("Chase").AddItem(new MenuItem("UseFullComboAfterChase", "技能全中后使用W").SetValue(true));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("ManaLaneClear", "最低 蓝量 清线").SetValue(new Slider(40, 1, 100)));

            Config.AddSubMenu(new Menu("冻 结", "Freeze"));
            ...
            Config.SubMenu("Freeze").AddItem(new MenuItem("UseQFreeze", "最后一下用Q").SetValue(false));
            Config.SubMenu("Freeze").AddItem(new MenuItem("ManaFreeze", "最低 蓝量 Q").SetValue(new Slider(40, 1, 100)));

            Config.AddSubMenu(new Menu("杂项", "Misc"));
            Config.SubMenu("Misc").AddItem(new MenuItem("PacketCast", "使用 封包").SetValue(true));
            Config.SubMenu("Misc").AddItem(new MenuItem("TearExploit", "使用 开发功能").SetValue(true));

            Config.AddSubMenu(new Menu("防 突进", "GapCloser"));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("BarrierGapCloser", "防 突进").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("WGapCloser", "W 防突进").SetValue(true));
            Config.SubMenu("GapCloser").AddItem(new MenuItem("WInterruptSpell", "W 打断").SetValue(true));
            ...
            Config.SubMenu("Drawings").AddItem(new MenuItem("ComboDamage", "显示 连招 伤害").SetValue(true));
