...
namespace D_Shyvana
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //D Shyvana
            _config = new Menu("〖L#中文社区〗D-龙女", "D-Shyvana", true);
            ...
            */
            ...
            _config.SubMenu("Farm")
                .SubMenu("LaneClear")
                .AddItem(new MenuItem("UseItemslane", "使用物品清线"))
                .SetValue(true);
            ...
            _config.SubMenu("Smite")
                .AddItem(
                    new MenuItem("Usesmite", "惩戒 (自动)").SetValue(new KeyBind("H".ToCharArray()[0],
                        KeyBindType.Toggle)));
            _config.SubMenu("Smite").AddItem(new MenuItem("Usered", "提前惩戒红buff")).SetValue(true);
            _config.SubMenu("Smite")
                .AddItem(new MenuItem("healthJ", "提前惩戒红buff|血量低于").SetValue(new Slider(35, 1, 100)));
            ...
            _config.SubMenu("Misc").AddItem(new MenuItem("Gap_E", "R 防止突进")).SetValue(true);
            _config.SubMenu("Misc").AddItem(new MenuItem("UseRInt", "R 中断法术")).SetValue(true);
            // _config.SubMenu("Misc").AddItem(new MenuItem("MinTargetsgap", "min enemy >=(GapClosers)").SetValue(new Slider(2, 1, 5)));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinshy", "使用 换肤").SetValue(false));
            _config.SubMenu("Misc").AddItem(new MenuItem("skinshyvana", "皮肤 选择").SetValue(new Slider(4, 1, 6)));
            ...
            Game.PrintChat("<font color='#881df2'>D-榫欏コ by Diabaths</font> 鍔犺浇鎴愬姛!姹夊寲by浜岀嫍!QQ缇361630847!");
            ...
            Game.PrintChat(
               ("<font color = \"#FF0020\">鑴氭湰</font><font color = \"#22FF10\">鍔犺級鎴愬姛锛佹洿澶歸ww.loll35.com  </font>");
