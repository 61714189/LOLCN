...
namespace GagongSyndra
{
    class Program
    {
        ...
        static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Base menu
            Menu = new Menu("〖L#中文社区〗Gagong辛德拉", "GagongSyndra", true);
            orbwalkerMenu = new Menu("走砍", "Orbwalker");
            //SimpleTs
            Menu.AddSubMenu(new Menu("简易目标选择", "SimpleTs"));
            ...
            Game.PrintChat("<font color = \"#FF0020\">Gagong|杈涘痉鎷墊</font> by <font color = \"#22FF10\">stephenjason89</font>");
