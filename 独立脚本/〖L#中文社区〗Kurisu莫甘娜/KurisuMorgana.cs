...
namespace KurisuMorgana
{
    ...
    internal class KurisuMorgana
    {
        ...
        {
            _config = new Menu("〖L#中文社区〗Kurisu|莫甘娜|", "morgana", true);
            ...
            Game.PrintChat("<font color=\"#F2F2F2\">[|鑾敇濞渱]</font><font color=\"#D9D9D9\"> - <u>the Fallen Angel </u>  </font>- by Kurisu  鍔犺浇鎴愬姛");
        }
