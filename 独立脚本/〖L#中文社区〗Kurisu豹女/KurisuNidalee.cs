...
namespace KurisuNidalee
{
    ...
    internal class KurisuNidalee
    {
        ...
        private void NidaMenu()
        {
            ...
            nidaKeys.AddItem(new MenuItem("useclear", "清兵")).SetValue(new KeyBind(86, KeyBindType.Press));
            Config.AddSubMenu(nidaKeys);

            var nidaSpells = new Menu("法术", "spells");
            nidaSpells.AddItem(new MenuItem("hitchance", "命中率")).SetValue(new StringList(new[] { "低|", "中|", "高|" }, 2));
            nidaSpells.AddItem(new MenuItem("usehumanq", "使用标枪投掷")).SetValue(true);
            nidaSpells.AddItem(new MenuItem("usehumanw", "使用丛林伏击")).SetValue(true);
            nidaSpells.AddItem(new MenuItem(" ", " "));
            nidaSpells.AddItem(new MenuItem("usecougarq", "使用推到")).SetValue(true);
            nidaSpells.AddItem(new MenuItem("usecougarw", "使用猛扑")).SetValue(true);
            nidaSpells.AddItem(new MenuItem("pouncerange", "最小猛扑距离")).SetValue(new Slider(125, 50, 300));
            nidaSpells.AddItem(new MenuItem("usecougare", "使用豹形态")).SetValue(true);
            nidaSpells.AddItem(new MenuItem("usecougarr", "自动豹形态清兵清野")).SetValue(true);
            Config.AddSubMenu(nidaSpells);

            var nidaHeals = new Menu("治愈引擎", "hengine");
            ...
            foreach (var hero in ObjectManager.Get<Obj_AI_Hero>().Where(hero => hero.IsAlly))
            {
                ...
                nidaHeals.AddItem(new MenuItem("healpct" + hero.SkinName, hero.SkinName + " HP %")).SetValue(new Slider(50));
            }
            nidaHeals.AddItem(new MenuItem("healmanapct", "禁用治愈（魔法值）%")).SetValue(new Slider(40));
            Config.AddSubMenu(nidaHeals);


            var nidaHarass = new Menu("骚扰", "harass");
            nidaHarass.AddItem(new MenuItem("usehumanq2", "使用标枪投掷")).SetValue(true);
            nidaHarass.AddItem(new MenuItem("humanqpct", "禁用Q（法力值）%")).SetValue(new Slider(70));
            Config.AddSubMenu(nidaHarass);

            var nidaClear = new Menu("清线", "laneclear");
            nidaClear.AddItem(new MenuItem("clearhumanq", "使用标枪投掷")).SetValue(false);
            nidaClear.AddItem(new MenuItem(" ", " "));
            nidaClear.AddItem(new MenuItem("clearcougarq", "使用推到")).SetValue(true);
            nidaClear.AddItem(new MenuItem("clearcougarw", "使用猛扑")).SetValue(true);
            nidaClear.AddItem(new MenuItem("clearcougare", "使用豹形态")).SetValue(true);
            nidaClear.AddItem(new MenuItem("clearcougarr", "自动豹形态清线")).SetValue(false);
            nidaClear.AddItem(new MenuItem("clearpct", "禁用清线（法力值）%")).SetValue(new Slider(55));
            Config.AddSubMenu(nidaClear);

            var nidaJungle = new Menu("清野", "jungleclear");
            nidaJungle.AddItem(new MenuItem("jghumanq", "使用标枪投掷")).SetValue(true);
            nidaJungle.AddItem(new MenuItem("jghumanw", "使用丛林伏击")).SetValue(true);
            nidaJungle.AddItem(new MenuItem(" ", " "));
            nidaJungle.AddItem(new MenuItem("jgcougarq", "使用推到")).SetValue(true);
            nidaJungle.AddItem(new MenuItem("jgcougarw", "使用猛扑")).SetValue(true);
            nidaJungle.AddItem(new MenuItem("jgcougare", "使用豹形态")).SetValue(true);
            nidaJungle.AddItem(new MenuItem("jgcougarr", "自动豹形态清野")).SetValue(true);
            nidaJungle.AddItem(new MenuItem("jgrpct", "禁用清野（法力值）%")).SetValue(new Slider(55, 0, 100));
            Config.AddSubMenu(nidaJungle);

            var nidaMisc = new Menu("杂项", "nidamisc");
            nidaMisc.AddItem(new MenuItem("usedfg", "使用 道具")).SetValue(true);
            nidaMisc.AddItem(new MenuItem("usebork", "使用 破败")).SetValue(true);
            nidaMisc.AddItem(new MenuItem("usebw", "使用小弯刀")).SetValue(true);
            nidaMisc.AddItem(new MenuItem("useclaim", "使用冰霜女皇的旨令|")).SetValue(true);
            nidaMisc.AddItem(new MenuItem("useks", "抢人头")).SetValue(true);
            nidaMisc.AddItem(new MenuItem("swfks", "抢人头|切豹形态")).SetValue(false);
            Config.AddSubMenu(nidaMisc);

            var nidaD = new Menu("范围", "drawings");
            ...
            nidaD.AddItem(new MenuItem("drawcds", "显示技能冷却")).SetValue(true);
            ...
            Game.PrintChat("<font color=\"#FFAF4D\">[</font><font color=\"#FFA333\">???</font><font color=\"#FFAF4D\">]</font><font color=\"#FF8C00\"> - <u>the Bestial Huntress Rev106鍔犺浇鎴愬姛  </u>  </font>- Kurisu");
