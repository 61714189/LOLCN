...
namespace TheHatinEvelynn
{
    internal class Program
    {
        ...
        public static string WelcomeMsg = ("<font color = '#6600cc'>TheHatin' |浼婅姍鐞硘 </font><font color='#FFFFFF'>by Da'ath.</font> <font color = '#66ff33'> 鍔犺級鎴愬姛</font> ");
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            #region
            Menu = new Menu("〖L#中文社区〗寡妇制造者-伊芙琳", "Evelynn", true);
