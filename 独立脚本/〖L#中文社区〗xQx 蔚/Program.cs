...
namespace Vi
{
    internal class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            //Create the menu
            Config = new Menu("〖L#中文社区〗xQx | 蔚", "Vi", true);
            ...
            Config.SubMenu("Combo").SubMenu("FindHim")
                .AddItem(new MenuItem("ForceFocusctive", "启用强制锁定目标").SetValue(false));
            ...
            harassUseQ.AddItem(new MenuItem("UseQHarassDontUnderTurret", "塔下禁用 Q").SetValue(true));
            ...
            Game.PrintChat(
                String.Format(
                    "<font color='#70DBDB'>xQx |钄殀 </font> <font color='#FFFFFF'>{0}</font> <font color='#70DBDB'> 鍔犺級鎴愬姛</font>",
                    ChampionName));
