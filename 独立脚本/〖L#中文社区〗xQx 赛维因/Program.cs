...
namespace Swain
{
    ...
    {
        public const string ChampionName = "〖L#中文社区〗赛维因";
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            Config.SubMenu("Combo").AddItem(new MenuItem("UseAutoRCombo", "自动R").SetValue(true));
            ...
            Config.SubMenu("Harass").AddItem(new MenuItem("HarassMana", "最小的法力百分比：").SetValue(new Slider(50, 100, 0)));
            ...
            Config.SubMenu("LaneClear").AddItem(new MenuItem("LaneClearMana", "最小的法力百分比：: ").SetValue(new Slider(50, 100, 0)));
            ...
            //JungleFarm menu:
            Config.AddSubMenu(new Menu("打野", "JungleFarm"));
            ...
            Config.SubMenu("JungleFarm").AddItem(new MenuItem("JungleFarmMana", "最小的法力百分比：: ").SetValue(new Slider(50, 100, 0)));
